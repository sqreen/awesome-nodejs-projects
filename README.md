...
* [Monitaure](https://github.com/Bertrand31/Monitaure) ([website](https://monitaure.io)) - A progressive web app providing system administrators with a simple monitoring dashboard.
